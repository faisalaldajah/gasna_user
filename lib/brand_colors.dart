...
class BrandColors {
  static const Color colorPrimary = Color(0xFF54a0ff);
  static const Color colorPrimaryDark = Color(0xFF2e86de);
  static const Color colorAccent = Color(0xFFFFA500);
  static const Color colorAccent1 = Color(0xFFFFB52E);
  static const Color lightGrey = Color(0xffADADAF);
  ...
  static const Color colorMoreBlue = Color(0xFF1c3aa9);
